...
if getattr(st.session_state, 'logged_in', False):
    ...
    if navigation_option == "Make Predictions":
        ...
        desired_order = ['Beat', 'Year', 'Latitude', 'Longitude', 'Hour', 'Minute',
                         'Second', 'Holiday', 'Month', 'WeekOfYear', 'Quarter', 'Day',
                         'DayOfWeek', 'IsWeekend', 'IsWeekday', 'MonthBegin', 'MonthEnd']
        ...
        if st.button("See Predictions", key='4'):
            ...
            with st.spinner('Making Predictions...'):
                ...
                if predictions_multiclass == 0:
                    st.write("Prediction: :red[Assault]")
                elif predictions_multiclass == 1:
                    st.write("Prediction: :red[Battery]")
                elif predictions_multiclass == 2:
                    st.write("Prediction: :red[Criminal Damage]")
                elif predictions_multiclass == 3:
                    st.write("Prediction: :red[Narcotics]")
                elif predictions_multiclass == 4:
                    st.write("Prediction: :red[Other Offense]")
                elif predictions_multiclass == 5:
                    st.write("Prediction: :red[Theft]")
                else:
        ...
        st.divider()
        st.write("##### :blue[Select the Time Frame]")
        ...
        st.subheader("Crime Counts per Day of the Week")
        ...
        st.subheader("Crime Counts per Time of the Day")
        ...
        st.text("Night: 0:00 - 5:59   Morning: 6:00 - 11:59   Afternoon: 12:00 - 17:59   Evening: 18:00 - 23:59 ")
        ...
        st.subheader("Crime Counts per Hour of the Day")
